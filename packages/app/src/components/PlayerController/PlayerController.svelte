<script lang="ts">
  ...
  import { isMoveDirection, isRotationDirection } from './PlayerController.utils';
    ...
    if (type === BABYLON.KeyboardEventTypes.KEYDOWN) {
      switch (event.key) {
        ...
        case Key.e:
          ...
          break;
        case Key.d:
          updateRotationDirection(RotationDirection.Right);
          break;
        case Key.q:
          updateRotationDirection(RotationDirection.Left);
          break;
        default:
          break;
      }
